...
# [*] 문자에 대한 군집은 범주형이라 힘들다. kmodes 모델을 사용하거나 딥러닝 모델 사용. 
# [1] 범주형 --> 수치형(백터화) 변경  , 텍스트(자연어) 수치형 벡터로 변환
...
# [2] 전체 문장을 나열하여 총 7개의 키워드/단어 추출  : 사과,바나나,과일,식사,포도,멜론,단맛
# [3] 첫번째 문장은 7가지 키워드에 존재하는지 검토 , 존재하면 1, 존재하지 않으면 0
#        사과,바나나,과일,식사,포도,멜론,단맛  --> 1, 1, 1, 1, 0, 0, 0

# [4] 두번째 문장에서 7가지 키워드가 존재하는지 검토2
#        사과,바나나,과일,식사,포도,멜론,단맛  --> 0, 0, 1, 0, 1, 1, 1
# 스케일링
# [5] 1, 1, 1, 1, 0, 0, 0 제곱의 합으로 1 총합을 1으로 만든다.
